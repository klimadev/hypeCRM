    ...
    <div className="grid gap-4 md:grid-cols-[1.2fr_1fr]">
      ...
      <div className="space-y-4 rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-elevated)] p-4">
        ...
        <div className="space-y-2">
          {marcos.map((marco) => (
            <div key={marco.id} className={cn("flex items-center gap-2 rounded-md border px-2 py-1.5 text-xs", marco.done ? "border-[var(--success)]/40 bg-[color-mix(in_srgb,var(--success)_10%,transparent)] text-[var(--text-primary)]" : "border-[var(--border-subtle)] bg-[var(--surface)] text-[var(--text-tertiary)]")}>
