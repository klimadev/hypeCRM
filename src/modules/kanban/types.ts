...
export const CORES_ESTAGIO: Partial<Record<TipoEstagio, EstagioCor>> = {
  ...
  PROGRESSO: {
    bg: "bg-[color-mix(in_srgb,var(--info)_16%,transparent)]",
    text: "text-[var(--info)]",
    border: "border-[color-mix(in_srgb,var(--info)_36%,transparent)]",
    label: "Em Progresso",
  },
  SUCCESS: {
    bg: "bg-[color-mix(in_srgb,var(--success)_16%,transparent)]",
    text: "text-[var(--success)]",
    border: "border-[color-mix(in_srgb,var(--success)_36%,transparent)]",
    label: "Sucesso",
  },
  FALHA: {
    bg: "bg-[color-mix(in_srgb,var(--danger)_16%,transparent)]",
    text: "text-[var(--danger)]",
    border: "border-[color-mix(in_srgb,var(--danger)_36%,transparent)]",
    label: "Falha",
  },
  GANHO: {
    bg: "bg-[color-mix(in_srgb,var(--success)_16%,transparent)]",
